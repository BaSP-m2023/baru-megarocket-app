...
const Form = () => {
  ...
  const handlePutSubscription = async (newSubscription) => {
    try {
      ...
      if (success) {
        ...
        setResponseModal('Subscription has been edited');
        setState('success');
        setShowModal(true);
      } else {
        setShowConfirmModal(false);
        setResponseModal('An error has occurred');
        setState('fail');
        setShowModal(true);
      }
    } catch (error) {
  ...
  const onConfirm = () => {
    try {
      ...
      if (id) {
        handlePutSubscription(newSubscription);
      } else {
